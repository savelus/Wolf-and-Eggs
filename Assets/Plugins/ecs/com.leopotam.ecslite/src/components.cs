...
#endif
    public partial class EcsPool<T> : IEcsPool where T : struct {
        readonly Type _type;
        ...
        internal EcsPool (EcsWorld world, int id, int denseCapacity, int sparseCapacity, int recycledItemsCount) {
            _type = typeof (T);
            _world = world;
            _id = id;
            ...
            _denseItemsCount = 1;
            _recycledItems = new int[recycledItemsCount];
        ...
        public ref T AddRaw (int entity, object dataRaw) {
#if DEBUG
